...
export class StorageService {
    ...
    async uploadFile(file: Buffer, fileName: string, mimeType: string, companyId: string, companyName: string, category: 'invoices' | 'receipts' | 'other-documents' = 'other-documents') {
        try {
