...
import { getPublicServerPlans, getAllServerPlans, createServerPlan, updateServerPlan, deleteServerPlan } from '../services/serverPlans.service.js';
...
router.get('/subscription', requireAuth, async (req, res) => {
    try {
        ...
        const result = await executeQuery(`SELECT spp.max_users, spp.name, spp.analysis_cost, ss.status
             ...
             ORDER BY ss.created_at DESC LIMIT 1`, [companyId]);
